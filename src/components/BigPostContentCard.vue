<template>
  ...
  <div>
    <div class="post-card">
      <div class="post-image-wrapper">
        ...
        <div class="other-post-info" v-if="posterName != ''">
          ...
          <div v-if="comments == 1"><b>{{comments}}</b> comment</div>
          <div v-if="comments > 1"><b>{{comments}}</b> comments</div>
          <div v-if="comments <= 0">No comments</div>
        </div>
    ...
    <div v-if="isSignedIn" class="input-box-wrapper">
      ...
      <input v-model='commentText' type="text" placeholder="Leave a comment...">
    ...
    <div class="comments-wrapper">
        <CommentCard v-for="comment in commentsArray" :key="comment.id"
...
export default {
  ...
  methods: {
    ...
    async sendAlert() {
      ...
      .add({
        'type': 'comment',
        'notificationText': `${localStorage.getItem('name')} shared a comment`,
        'targetPageId': this.$route.params.id,
        'notificationTime': firebaseApp.serverTimestamp,
        'userId': localStorage.getItem('uid'),
        'username': localStorage.getItem('name'),
    ...
    async sharePhoto() {
      ...
      const shareData = {
        ...
        url: `https://grrid.netlify.app/status/${this.postId}`,
      };
